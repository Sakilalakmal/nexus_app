...
import { ChannelNameSchemaType } from "../schemas/channel";
import {
  init,
  organization_user,
  Organizations,
...
export const createChannel = base
  ...
  .route({
    ...
    description:
      "Creates a new channel within the specified workspace. Requires authentication and workspace context.",
    tags: ["Channel"],
  })
...
export const listChannels = base
  ...
  .route({
    ...
    description:
      "Retrieves all channels within the specified workspace. Requires authentication and workspace context.",
    tags: ["Channel"],
  })
  .input(z.void())
  .output(
...
export const getChannel = base
  ...
  .route({
    ...
    description:
      "Retrieves a specific channel by its ID within the specified workspace. Requires authentication and workspace context.",
    tags: ["Channel"],
  })
